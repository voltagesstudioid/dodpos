        ...
        <div class="ht-page">
            ...
            <div class="ht-hdr">
                ...
                <div>
                    ...
                    <div class="ht-hdr-sub">Arsip dan riwayat pembayaran pelanggan mineral yang sudah lunas</div>
                </div>
            </div>

            {{-- Filter --}}
            <div class="ht-filter">
                <form method="GET" action="{{ route('mineral.hutang.lunas') }}" class="ht-ff">
                    <div>
                    ...
                    <div class="ht-ff-actions">
                        ...
                        <a href="{{ route('mineral.hutang.lunas') }}" class="ht-fbtn ht-fbtn-ghost">
                            Reset
                        </a>
                        @endif
                    </div>
