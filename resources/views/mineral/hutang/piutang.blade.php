        ...
        <div class="ht-page">
            ...
            <div class="ht-hdr">
                ...
                <div>
                    ...
                    <div class="ht-hdr-sub">Monitoring tagihan dan piutang pelanggan mineral</div>
                </div>
            </div>
            ...
            {{-- Filter --}}
            <div class="ht-filter">
                <form method="GET" action="{{ route('mineral.hutang.piutang') }}" class="ht-ff">
                    <div>
                    ...
                    <div class="ht-ff-actions">
                        <button type="submit" class="ht-fbtn ht-fbtn-primary">
                        ...
                        <a href="{{ route('mineral.hutang.piutang') }}" class="ht-fbtn ht-fbtn-ghost">
                            Reset
                        </a>
                        @endif
                    </div>
