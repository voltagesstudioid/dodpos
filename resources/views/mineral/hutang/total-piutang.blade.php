<x-app-layout>
    ...
    <div class="cs-page">
        ...
        <div class="cs-summary">
            ...
            <div class="cs-summary-actions">
                <a href="{{ route('mineral.hutang.piutang') }}" class="cs-btn-secondary">Kembali ke Daftar Piutang</a>
            </div>
                ...
                <table class="cs-tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="{{ route('mineral.hutang.piutang', ['pelanggan_id' => $p->id]) }}" class="cs-btn-primary cs-btn-sm">
