...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .rpt-logo { font-size:1.25rem; font-weight:800; color:#1e40af; letter-spacing:-0.02em; }
        ...
        .rpt-total-box { background:#eff6ff; border:1.5px solid #93c5fd; border-radius:6px; padding:0.75rem; margin:0.75rem 0; }
        .rpt-total-row { display:flex; justify-content:space-between; align-items:center; }
        .rpt-total-lbl { font-size:0.8125rem; font-weight:700; color:#1e40af; }
        .rpt-total-val { font-size:1.125rem; font-weight:800; color:#1e40af; }
        ...
        .rpt-thanks { font-size:0.6875rem; font-weight:600; color:#1e40af; }
        ...
        .print-btn {
            ...
            box-shadow:0 6px 20px rgba(37,99,235,0.25); transition:all 0.2s;
        }
        .print-btn:hover { transform:translateY(-1px); box-shadow:0 8px 28px rgba(37,99,235,0.35); }
        @media print {
