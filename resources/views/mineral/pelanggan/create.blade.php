<x-app-layout>
    ...
    <div class="pcf-page">
        ...
        <nav class="pcf-nav">
            ...
            <span class="pcf-nav-crumb">Tambah Baru</span>
        </nav>
        ...
        <div class="pcf-hdr">
            ...
            <div>
                <div class="pcf-hdr-title">Tambah Pelanggan Mineral</div>
                <div class="pcf-hdr-sub">Isi data pelanggan baru untuk divisi mineral</div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('mineral.pelanggan.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="pcf-card-body">
                    <div class="pcf-grid">
                        ...
                        <div class="pcf-full">
                            ...
                            <input type="text" name="nama_toko" value="{{ old('nama_toko') }}" required placeholder="Contoh: Toko Maju Jaya" class="pcf-input" maxlength="100" autocomplete="off">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_pemilik" value="{{ old('nama_pemilik') }}" required placeholder="Nama lengkap pemilik" class="pcf-input" autocomplete="off">
                        ...
                        <div>
                            ...
                            <div class="pcf-input-wrap">
                                ...
                                <input type="text" name="no_hp" value="{{ old('no_hp') }}" placeholder="81234567890" class="pcf-input has-prefix" inputmode="numeric">
                            </div>
                        ...
                        <div class="pcf-full">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}" placeholder="email@contoh.com" class="pcf-input" autocomplete="off">
                ...
                <div class="pcf-card-body">
                    ...
                    <div class="pcf-grid">
                        ...
                        <div class="pcf-full">
                            ...
                            <textarea name="alamat" rows="3" placeholder="Jl. Contoh No. 123, RT/RW, Kelurahan" class="pcf-input green">{{ old('alamat') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="text" name="kecamatan" value="{{ old('kecamatan') }}" placeholder="Nama kecamatan" class="pcf-input green" autocomplete="off">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="kota" value="{{ old('kota') }}" placeholder="Nama kota" class="pcf-input green" autocomplete="off">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="latitude" value="{{ old('latitude') }}" placeholder="-6.123456" class="pcf-input green">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="longitude" value="{{ old('longitude') }}" placeholder="106.123456" class="pcf-input green">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pcf-card">
                ...
                <div class="pcf-card-body">
                    <div id="foto-preview-wrap" style="text-align:center; margin-bottom:1rem;">
                        <img id="foto-preview" src="" alt="Preview" style="display:none; max-width:100%; max-height:300px; border-radius:12px; border:2px solid #e2e8f0;">
                    </div>
            ...
            <div class="pcf-card">
                ...
                <div class="pcf-card-body">
                    ...
                    <div class="pcf-radio-grid" id="tipeGroup">
                        <label class="pcf-radio-card {{ old('tipe', 'eceran') == 'eceran' ? 'selected' : '' }}" style="--c:#2563eb;--bg:#eff6ff;--ring:rgba(37,99,235,0.12);" onclick="selRadio(this)">
                        ...
                        <label class="pcf-radio-card {{ old('tipe') == 'grosir' ? 'selected' : '' }}" style="--c:#7c3aed;--bg:#f5f3ff;--ring:rgba(124,58,237,0.12);" onclick="selRadio(this)">
                        ...
                        <label class="pcf-radio-card {{ old('tipe') == 'agen' ? 'selected' : '' }}" style="--c:#ea580c;--bg:#fff7ed;--ring:rgba(234,88,12,0.12);" onclick="selRadio(this)">
                    ...
                    <div class="pcf-radio-grid" id="statusGroup">
                        <label class="pcf-radio-card {{ old('status', 'aktif') == 'aktif' ? 'selected' : '' }}" style="--c:#059669;--bg:#ecfdf5;--ring:rgba(5,150,105,0.12);" onclick="selRadio(this)">
                        ...
                        <label class="pcf-radio-card {{ old('status') == 'nonaktif' ? 'selected' : '' }}" style="--c:#64748b;--bg:#f8fafc;--ring:rgba(100,116,139,0.12);" onclick="selRadio(this)">
                        ...
                        <label class="pcf-radio-card {{ old('status') == 'blacklist' ? 'selected' : '' }}" style="--c:#dc2626;--bg:#fef2f2;--ring:rgba(220,38,38,0.12);" onclick="selRadio(this)">
                    ...
                    <div class="pcf-grid">
                        <div>
                            ...
                            <div class="pcf-input-wrap">
                                ...
                                <input type="text" name="limit_hutang" id="limitHutang" value="{{ old('limit_hutang') }}" placeholder="0" class="pcf-input has-prefix purple" inputmode="numeric">
                            </div>
                            <div class="pcf-hint">
                                ...
                                Kosongkan jika tidak ada limit
                            </div>
