                        ...
                        <div class="fm-grid fm-grid-2">
                            ...
                            <div>
                                ...
                                <select name="satuan_id" required class="fm-input">
                                    ...
                                    @php $satuanVal = old('satuan_id', $produk->satuan_id); @endphp
                                    @foreach($satuanList as $s)
                                        <option value="{{ $s->id }}" {{ $satuanVal == $s->id ? 'selected' : '' }}>{{ $s->nama }}@if($s->singkatan) ({{ $s->singkatan }})@endif</option>
                                    @endforeach
                                    @if($produk->satuan_id && !$satuanList->contains('id', $produk->satuan_id))
                                        <option value="{{ $produk->satuan_id }}" selected>{{ $produk->satuanRel?->nama ?? $produk->satuan }} (arsip)</option>
                                    @endif
                                </select>
