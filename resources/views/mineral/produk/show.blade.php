<x-app-layout>
    ...
    <style>
        ...
        .ps-card.amber .ps-card-hdr { background:linear-gradient(135deg,#fffbeb,#fef3c7); }
        .ps-card.amber .ps-card-ico { background:linear-gradient(135deg,#f59e0b,#d97706); color:#fff; }
        ...
        .ps-btn-edit { background:linear-gradient(135deg,#3b82f6,#2563eb); color:#fff; box-shadow:0 4px 14px rgba(37,99,235,0.25); }
        .ps-btn-edit:hover { transform:translateY(-1px); box-shadow:0 8px 24px rgba(37,99,235,0.35); }
    ...
    <div class="ps-page">
        ...
        {{-- Breadcrumb --}}
        <nav class="ps-nav">
            <a href="{{ route('mineral.produk.index') }}" class="ps-back">
        ...
        <div class="ps-actions">
            <a href="{{ route('mineral.produk.index') }}" class="ps-btn ps-btn-back">
            ...
            <a href="{{ route('mineral.produk.edit', $produk->id) }}" class="ps-btn ps-btn-edit">
