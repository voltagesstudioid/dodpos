<x-app-layout>
    ...
    <div class="py-4">
        <div class="rg-page">
            ...
            <form method="POST" action="{{ route('mineral.regional.update', $regional) }}" class="rg-form">
                @csrf @method('PUT')
                        ...
                        <table class="rg-harga-tbl">
                            ...
                            <tbody>
                                @foreach($produks as $produk)
                                    @php
                                        $existingHarga = $regional->hargaProduk->where('produk_id', $produk->id)->first();
                                        $currentHarga = $existingHarga ? $existingHarga->harga_jual : null;
                                    @endphp
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" inputmode="numeric" data-currency name="harga[{{ $produk->id }}]" class="rg-harga-inp"
                                                placeholder="{{ number_format($produk->harga_jual, 0, ',', '.') }}"
                                                value="{{ old('harga.' . $produk->id, $currentHarga ? (int) $currentHarga : '') }}">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
