<x-app-layout>
    @push('styles')
    <style>
        .rg-page { max-width:60rem; margin:0 auto; padding:0 1rem; font-family:'Plus Jakarta Sans',system-ui,sans-serif; }
        ...
        .rg-btn-edit { background:linear-gradient(135deg,#3b82f6,#2563eb); color:#fff; box-shadow:0 6px 20px rgba(37,99,235,0.3); }
        .rg-btn-edit:hover { transform:translateY(-1px); box-shadow:0 8px 28px rgba(37,99,235,0.4); }
        ...
        .rg-card-title {
            ...
            color:#2563eb; margin-bottom:1rem; padding-bottom:0.5rem; border-bottom:2px solid #dbeafe;
        }
        ...
        <div class="rg-page">
            ...
            <div class="rg-hdr">
                ...
                <div class="rg-hdr-actions">
                    <a href="{{ route('mineral.regional.index') }}" class="rg-btn rg-btn-back">← Kembali</a>
                    <a href="{{ route('mineral.regional.edit', $regional) }}" class="rg-btn rg-btn-edit">
