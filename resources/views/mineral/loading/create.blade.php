<x-app-layout>
    ...
    <div class="fm-page">
        ...
        <nav class="fm-nav">
            ...
            <span class="fm-nav-crumb">Tambah Baru</span>
        </nav>
        ...
        <div class="fm-hdr">
            ...
            <div>
                <div class="fm-hdr-title">Tambah Loading</div>
                <div class="fm-hdr-sub">Distribusi mineral ke kendaraan sales</div>
            </div>
        </div>
        ...
        <div class="fm-tip">
            ...
            <div class="fm-tip-text">Isi data loading harian untuk sales. Field bertanda <strong>*</strong> wajib diisi. Jumlah loading tidak boleh melebihi stok gudang.</div>
        </div>

        <form method="POST" action="{{ route('mineral.loading.store') }}">
            @csrf
                ...
                <div class="fm-card-body">
                    <div class="fm-grid fm-grid-2">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" required class="fm-input">
                    ...
                    <div class="fm-grid fm-grid-2">
                        ...
                        <div>
                            ...
                            <div class="fm-input-wrap">
                                <input type="number" name="jumlah_loading" id="jumlahInput" value="{{ old('jumlah_loading') }}" required min="0.01" step="any" placeholder="Contoh: 50" class="fm-input has-suffix green">
                        ...
                        <div class="fm-full">
                            ...
                            <textarea name="keterangan" rows="3" placeholder="Catatan tambahan (opsional)" class="fm-input green">{{ old('keterangan') }}</textarea>
    ...
    (function() {
        ...
        function updateUnit() {
            ...
            if (satuan && stok >= 0) {
                ...
                if (stok > 0) {
                    ...
                    stockText.textContent = 'Stok gudang tersedia: ' + fmt(stok) + ' ' + satuan;
                } else {
                    stockInd.className = 'fm-stock danger';
                    stockText.textContent = 'Stok gudang kosong! Tidak bisa loading produk ini.';
                }
            } else {
        ...
        function checkStock() {
            ...
            if (jumlah > 0 && stok > 0) {
                ...
                if (jumlah > stok) {
                    stockInd.className = 'fm-stock danger';
                    stockText.textContent = 'Melebihi stok! Tersedia: ' + fmt(stok) + ' ' + satuan + ', diinput: ' + fmt(jumlah) + ' ' + satuan;
                } else {
                    stockInd.className = 'fm-stock ok';
                    stockText.textContent = 'Stok gudang tersedia: ' + fmt(stok) + ' ' + satuan + ' (sisa: ' + fmt(stok - jumlah) + ')';
                }
            }
        }
