<x-app-layout>
    ...
    <style>
        ...
        .ld-hdr-btn:hover { transform:translateY(-2px); box-shadow:0 10px 32px rgba(37,99,235,0.45); }
        ...
        .ld-kpi.blue::before   { background:linear-gradient(180deg,#3b82f6,#2563eb); }
        ...
        .ld-kpi-ico { width:52px; height:52px; border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.5rem; }
        .ld-kpi-ico.blue   { background:linear-gradient(135deg,#eff6ff,#dbeafe); }
        ...
        .ld-finput:focus { border-color:#3b82f6; box-shadow:0 0 0 3px rgba(59,130,246,0.12); }
        .ld-fsel {
        ...
        .ld-fsel:focus { border-color:#3b82f6; box-shadow:0 0 0 3px rgba(59,130,246,0.12); }
        .ld-btn-f {
        ...
        .ld-btn-f:hover { transform:translateY(-1px); box-shadow:0 6px 18px rgba(37,99,235,0.35); }
        .ld-btn-r {
            padding:0.625rem 1.25rem; border-radius:10px; font-size:0.8125rem; font-weight:600;
        ...
        .ld-tbl-head { background:linear-gradient(180deg,#eff6ff,#f0f7ff); border-bottom:2px solid #bfdbfe; }
        .ld-tbl-head th {
        ...
        .ld-tbl-body td { padding:0.9375rem 1.25rem; border-bottom:1px solid #f1f5f9; font-size:0.8125rem; color:#374151; vertical-align:middle; }
        .ld-tbl-body tr { transition:background 0.15s; }
        .ld-tbl-body tr:last-child td { border-bottom:none; }
        .ld-tbl-body tr:hover td { background:linear-gradient(90deg,#f8faff,#eff6ff); }

        /* Date cell */
        .ld-date { display:flex; align-items:center; gap:0.375rem; }
        .ld-date-ico { color:#94a3b8; flex-shrink:0; }
        .ld-date-val { font-size:0.8125rem; font-weight:600; color:#1e293b; }
        ...
        /* Product cell */
        .ld-prod { font-size:0.8125rem; font-weight:500; color:#1e293b; }

        /* Volume cells */
        .ld-vol { text-align:right; }
        .ld-vol-main { font-size:0.875rem; font-weight:700; color:#1e293b; }
        .ld-vol-unit { font-size:0.75rem; font-weight:500; color:#94a3b8; margin-left:0.125rem; }
        .ld-vol-green .ld-vol-main { color:#059669; }
        .ld-vol-blue .ld-vol-main { color:#2563eb; }
        .ld-vol-amber .ld-vol-main { color:#d97706; }
        ...
        .ld-status.loading  { background:#eff6ff; color:#2563eb; border-color:#bfdbfe; }
        ...
        .ld-status-dot.loading  { background:#3b82f6; box-shadow:0 0 0 2px rgba(59,130,246,0.2); animation:ld-pulse 1.5s infinite; }
        ...
        .ld-act.detail { background:#eff6ff; color:#1d4ed8; border-color:#bfdbfe; }
        .ld-act.detail:hover { background:#dbeafe; border-color:#93c5fd; }
        ...
        <div class="ld-page">
                    ...
                    <div class="ld-kpi-top">
                        <div class="ld-kpi-left">
                            ...
                            @else
                                ...
                                @endforeach
                            @endif
                            <div class="ld-kpi-foot">Volume distribusi hari ini</div>
                        </div>
                ...
                <div class="ld-kpi green">
                    <div class="ld-kpi-top">
                        <div class="ld-kpi-left">
                            ...
                            <div class="ld-kpi-foot">Sales yang menerima loading</div>
                        </div>
            ...
            <div class="ld-filter">
                <form method="GET" class="ld-ff">
                    ...
                    <a href="{{ route('mineral.loading.index') }}" class="ld-btn-r">
                                ...
                                <tr>
                                    <td>
                                        <div class="ld-date">
                                            ...
                                            <span class="ld-date-val">{{ $l->tanggal->format('d M Y') }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="ld-sales">
