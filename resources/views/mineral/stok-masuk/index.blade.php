<x-app-layout>
    ...
    <style>
        ...
        .sm-hdr-ico { width:52px; height:52px; border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.5rem; flex-shrink:0; background:linear-gradient(135deg,#06b6d4,#0891b2); box-shadow:0 8px 24px rgba(8,145,178,0.3); }
        ...
        .sm-hdr-btn { display:inline-flex; align-items:center; gap:0.5rem; padding:0.7rem 1.375rem; border-radius:12px; font-size:0.8125rem; font-weight:600; text-decoration:none; transition:all 0.25s; border:none; cursor:pointer; background:linear-gradient(135deg,#06b6d4,#0891b2); color:#fff; box-shadow:0 4px 14px rgba(8,145,178,0.35); }
        .sm-hdr-btn:hover { transform:translateY(-2px); box-shadow:0 8px 24px rgba(8,145,178,0.45); }
        ...
        .sm-kpi.cyan::before { background:linear-gradient(180deg,#06b6d4,#0891b2); }
        ...
        .sm-finput:focus { border-color:#06b6d4; box-shadow:0 0 0 3px rgba(6,182,212,0.12); }
        ...
        .sm-fsel:focus { border-color:#06b6d4; box-shadow:0 0 0 3px rgba(6,182,212,0.12); }
        .sm-btn-f { padding:0.625rem 1.25rem; border-radius:10px; font-size:0.8125rem; font-weight:600; border:none; cursor:pointer; transition:all 0.2s; font-family:inherit; background:linear-gradient(135deg,#06b6d4,#0891b2); color:#fff; box-shadow:0 4px 12px rgba(8,145,178,0.25); }
        .sm-btn-f:hover { transform:translateY(-1px); box-shadow:0 6px 18px rgba(8,145,178,0.35); }
        ...
        .sm-tbl-head { background:linear-gradient(180deg,#ecfeff,#cffafe); border-bottom:2px solid #67e8f9; }
        .sm-tbl-head th { padding:0.9rem 1.25rem; font-size:0.675rem; font-weight:700; text-transform:uppercase; letter-spacing:0.07em; color:#155e75; white-space:nowrap; }
        ...
        .sm-tbl-body tr:hover td { background:linear-gradient(90deg,#ecfeff,#f0fdfa); }
        ...
        .sm-empty-ico { width:72px; height:72px; margin:0 auto 1rem; border-radius:50%; background:linear-gradient(135deg,#ecfeff,#cffafe); display:flex; align-items:center; justify-content:center; }
        ...
        .sm-empty-cta { display:inline-flex; align-items:center; gap:0.5rem; padding:0.625rem 1.25rem; border-radius:10px; font-size:0.8125rem; font-weight:600; background:linear-gradient(135deg,#06b6d4,#0891b2); color:#fff; text-decoration:none; box-shadow:0 4px 14px rgba(8,145,178,0.25); transition:all 0.2s; }
    ...
    <div class="py-4">
        <div class="sm-page">
            ...
            {{-- KPI --}}
            <div class="sm-kpis">
                <div class="sm-kpi cyan">
                    <span class="sm-kpi-lbl">Total Penerimaan</span>
                    <div class="sm-kpi-val cyan">{{ number_format($stats['total_penerimaan'], 0, ',', '.') }}</div>
            ...
            <div class="sm-filter">
                <form method="GET" class="sm-ff">
                    ...
                    <a href="{{ route('mineral.stok-masuk.index') }}" class="sm-btn-r">Reset</a>
                </form>
            </div>
