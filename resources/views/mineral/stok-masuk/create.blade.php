<x-app-layout>
    ...
    <style>
        ...
        .sc-hdr-tag { display:inline-block; font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:.08em; color:#06b6d4; background:#ecfeff; padding:3px 10px; border-radius:20px; margin-bottom:6px; }
        ...
        .sc-sec-ico.cyan { background:#ecfeff; color:#0891b2; }
        ...
        .sc-inp:focus { border-color:#06b6d4; background:#fff; box-shadow:0 0 0 3px rgba(6,182,212,.08); }
        ...
        .sc-sel:focus { border-color:#06b6d4; background-color:#fff; box-shadow:0 0 0 3px rgba(6,182,212,.08); }
        ...
        .sc-ta:focus { border-color:#06b6d4; background:#fff; box-shadow:0 0 0 3px rgba(6,182,212,.08); }
        ...
        .sc-radio-pill input:checked + .sc-radio-face { border-color:#06b6d4; background:linear-gradient(180deg,#ecfeff,#f0fdfa); box-shadow:0 0 0 3px rgba(6,182,212,.1); }
        .sc-radio-pill input:checked + .sc-radio-face .lbl { color:#155e75; }
        .sc-radio-pill:hover .sc-radio-face { border-color:#67e8f9; }
        ...
        .sc-stok-box { background:#f0fdfa; border:1px solid #99f6e4; border-radius:10px; padding:12px 14px; margin-top:10px; }
        .sc-stok-lbl { font-size:11px; font-weight:700; color:#115e59; text-transform:uppercase; letter-spacing:.06em; }
        .sc-stok-val { font-size:1.5rem; font-weight:800; color:#0891b2; font-family:'JetBrains Mono',monospace; }
        ...
        .sc-btn-submit { flex:1; display:inline-flex; align-items:center; justify-content:center; gap:8px; padding:12px 24px; border-radius:12px; font-size:14px; font-weight:700; border:none; cursor:pointer; transition:all .25s; font-family:inherit; background:linear-gradient(135deg,#06b6d4,#0891b2); color:#fff; box-shadow:0 4px 16px rgba(8,145,178,.25); }
        .sc-btn-submit:hover { transform:translateY(-1px); box-shadow:0 8px 28px rgba(8,145,178,.35); }
    ...
    <div class="sc-page">
        ...
        <form method="POST" action="{{ route('mineral.stok-masuk.store') }}" id="form-stok">@csrf
            ...
            <div class="sc-submit-bar"><a href="{{ route('mineral.stok-masuk.index') }}" class="sc-btn-cancel">Batal</a><button type="submit" class="sc-btn-submit"><svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Simpan</button></div>
        </form></div>
    @push('scripts')
    <script>
