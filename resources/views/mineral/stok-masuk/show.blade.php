<x-app-layout>
    ...
    <style>
        ...
        .sm-hdr.penerimaan { background:linear-gradient(135deg,#06b6d4 0%,#0891b2 100%); }
        ...
        .sm-sec-ico.cyan { background:#ecfeff; color:#0891b2; }
    ...
    @endpush
    <div class="sm-page">
        <a href="{{ route('mineral.stok-masuk.index') }}" class="sm-back"><svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg> Kembali ke Daftar</a>
        ...
        <div class="sm-sec">
            <div class="sm-sec-hdr">
                <div class="sm-sec-ico cyan"><svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg></div>
        ...
        <div class="sm-actions">
            <a href="{{ route('mineral.stok-masuk.index') }}" class="sm-btn sm-btn-outline">
            ...
            <form method="POST" action="{{ route('mineral.stok-masuk.destroy', $stokMasuk) }}" onsubmit="return confirm('Yakin ingin membatalkan data ini? Stok akan disesuaikan kembali.');" style="flex:1;">
                @csrf @method('DELETE')
