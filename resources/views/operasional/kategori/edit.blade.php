<x-app-layout>
    ...
    <div class="tr-page-wrapper">
        <div class="tr-form-container">
            ...
            <nav class="tr-nav-breadcrumb">
                ...
                <span class="tr-current">Edit: {{ $kategori->name }}</span>
            </nav>
            ...
            <div class="tr-card">
                <div class="tr-card-header">
                    ...
                    <div class="tr-header-text">
                        <h2 class="tr-card-title">Perbarui Kategori</h2>
                        <p class="tr-card-subtitle">Ubah nama atau deskripsi kategori operasional yang sudah ada.</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('operasional.kategori.update', $kategori->id) }}" method="POST">
                        ...
                        <div class="tr-form-group">
                            ...
                            <textarea name="description" 
                                ...
                                rows="4" 
                                placeholder="Tambahkan rincian penggunaan kategori ini...">{{ old('description', $kategori->description) }}</textarea>
                            @error('description') <div class="tr-error-msg">{{ $message }}</div> @enderror
                        </div>

                        {{-- Action Buttons --}}
                        <div class="tr-form-actions">
                            <a href="{{ route('operasional.kategori.index') }}" class="tr-btn tr-btn-light">Batal</a>
    ...
    <style>
        ...
        .tr-textarea { resize: vertical; min-height: 120px; line-height: 1.5; }
