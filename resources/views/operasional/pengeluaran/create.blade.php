<x-app-layout>
        ...
        <div class="tr-page">
            ...
            <div class="tr-header">
                <div class="tr-header-text">
                    ...
                    <p class="tr-subtitle">Rekam setiap pengeluaran kas operasional toko dengan detail dan akurat.</p>
                </div>
            ...
            <div class="tr-card">
                <div class="tr-card-header">
                    <h2 class="tr-section-title">Detail Transaksi Pengeluaran</h2>
                    <span class="tr-badge tr-badge-gray">Input Baru</span>
                </div>

                <form id="expenseForm" action="{{ route('operasional.pengeluaran.store') }}" method="POST" class="tr-form-main">
                    @csrf
                    ...
                    <div class="tr-form-grid-3">
                        ...
                        {{-- Nominal --}}
                        <div class="tr-form-group">
                            <label class="tr-label">Nominal <span class="tr-req">*</span></label>
                            ...
                            <div class="tr-input-hint">Isi tanpa titik/koma (cth: 50000)</div>
                    ...
                    <div class="tr-form-grid-2">
                        ...
                        {{-- Kosong untuk menyeimbangkan grid di desktop --}}
                        <div class="tr-spacer-hide-mobile"></div>
                    </div>
                    ...
                    <div class="tr-form-group" style="margin-top: 1rem;">
                        ...
                        <textarea name="notes" class="tr-textarea @error('notes') is-invalid @enderror" 
                            rows="4" placeholder="Contoh: Isi bensin truk pengiriman 10 liter, Token listrik kantor bulan Februari...">{{ old('notes') }}</textarea>
                        @error('notes') <div class="tr-error-msg">{{ $message }}</div> @enderror
                    </div>

                    {{-- Footer Actions --}}
                    <div class="tr-form-actions">
                        <a href="{{ route('operasional.riwayat.index') }}" class="tr-btn tr-btn-light">Batalkan</a>
    ...
    <style>
        ...
        .tr-btn-dark { background: var(--tr-text-main); color: white; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); }
        ...
        .tr-form-grid-2 { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem; }
        .tr-form-group { margin-bottom: 1.25rem; }
        .tr-form-divider { height: 1px; background: #f1f5f9; margin: 1.5rem 0 2rem; }
        ...
        .tr-textarea { resize: vertical; min-height: 100px; }
        ...
        .tr-error-msg { color: var(--tr-danger); font-size: 0.75rem; font-weight: 600; margin-top: 6px; }
        ...
        @media (max-width: 640px) {
            ...
            .tr-spacer-hide-mobile { display: none; }
        }
    </style>
    @endpush
</x-app-layout>