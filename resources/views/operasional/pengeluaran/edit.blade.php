<x-app-layout>
    ...
    <div class="page-container" style="max-width: 980px;">
        <div class="page-header">
            <div>
                <div class="page-header-title">✏️ Edit Pengeluaran Operasional</div>
                <div class="page-header-subtitle">Perbarui data pengeluaran kas operasional</div>
            </div>
            <div class="page-header-actions">
                <a href="{{ route('operasional.riwayat.index') }}" class="btn-secondary">📋 Riwayat</a>
                <button type="submit" form="expenseEditForm" class="btn-primary">💾 Simpan</button>
            </div>
        </div>
        ...
        <div class="panel">
            <div class="panel-header">
                ...
                <span class="badge badge-gray">Edit</span>
            </div>
            <div class="panel-body">
            <form id="expenseEditForm" action="{{ route('operasional.pengeluaran.update', $pengeluaran) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-row" style="margin-top: 1rem;">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <textarea name="notes" class="form-input" rows="2" placeholder="Contoh: Isi bensin truk pengiriman 10 liter, Token listrik kantor, Servis motor...">{{ old('notes', $pengeluaran->notes) }}</textarea>
