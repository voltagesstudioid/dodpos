        ...
        <div class="tr-page">
            ...
            <div class="quick-actions">
                <div class="quick-actions-header">
                    ...
                    <p>Lakukan aksi penting dengan satu klik</p>
                </div>
                <div class="quick-actions-grid">
                    <a href="{{ route('gudang.penerimaan.create') }}" class="quick-action-card">
                        ...
                        <div class="quick-action-content">
                            <h4>Terima Barang</h4>
                            <p>Input stok masuk baru</p>
                        </div>
                    </a>
                    <a href="{{ route('gudang.terimapo.index') }}" class="quick-action-card">
                        ...
                        <div class="quick-action-content">
                            <h4>Terima dari PO</h4>
                            <p>Proses barang dari Purchase Order</p>
                        </div>
                    </a>
                    <a href="{{ route('gudang.penerimaan.export', request()->only(['search', 'source_type', 'date_from', 'date_to'])) }}" class="quick-action-card">
                        ...
                        <div class="quick-action-content">
                            <h4>Export Data</h4>
                            <p>Download data dalam format CSV</p>
                        </div>
                    </a>
                    <a href="{{ route('gudang.penerimaan') }}?source_type=retur_pelanggan" class="quick-action-card">
                        ...
                        <div class="quick-action-content">
                            <h4>Lihat Retur</h4>
                            <p>Data barang retur dari pelanggan</p>
                        </div>
                    </a>
                </div>
            </div>
