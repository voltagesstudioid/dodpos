    ...
    <div class="page-container">
        ...
        <div class="header-section">
            <div>
                <div class="header-title">
                    <svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
                    Tambah Pengguna Baru
                </div>
                <div class="header-subtitle">Buat akun untuk staf atau karyawan baru dalam sistem.</div>
            </div>
        ...
        @if($errors->any())
            <div class="alert-box alert-danger">
                ...
                <span>Mohon periksa kembali formulir di bawah, ada beberapa kesalahan.</span>
            </div>
        @endif
                ...
                <form method="POST" action="{{ route('pengguna.store') }}">
                    ...
                    <div class="form-grid cols-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name', request('name')) }}" class="form-control @error('name') is-invalid @enderror" placeholder="Nama staf" required autofocus>
                            @error('name') <div class="error-text">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label class="form-label">Nomor Induk (NIK) <span class="req">*</span></label>
                            <input type="text" name="nik" value="{{ old('nik') }}" class="form-control @error('nik') is-invalid @enderror" placeholder="Nomor pegawai" required>
                            @error('nik') <div class="error-text">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label class="form-label">Email / User ID <span class="req">*</span></label>
                            <input type="email" name="email" value="{{ old('email', request('email')) }}" class="form-control @error('email') is-invalid @enderror" placeholder="email@contoh.com" required>
                            @error('email') <div class="error-text">{{ $message }}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label class="form-label">No. Fingerprint (Opsional)</label>
                            <input type="text" name="fingerprint_id" value="{{ old('fingerprint_id', request('fingerprint_id')) }}" class="form-control @error('fingerprint_id') is-invalid @enderror" placeholder="ID mesin absen (CTH: 41)">
                    ...
                    <div class="form-grid cols-2">
                        <div class="form-group">
                            <label class="form-label">Kata Sandi (Password) <span class="req">*</span></label>
                    ...
                    <div class="form-group" style="margin-top: 1.5rem;">
                        <label class="checkbox-wrap">
                            <input type="checkbox" name="active" value="1" {{ old('active','1')=='1' ? 'checked':'' }} class="checkbox-input">
                            <span class="form-label" style="margin:0;">Aktifkan akun ini (Langsung bisa login)</span>
                        </label>
                    </div>
        ...
        <div class="mvc-helper">
            <div style="font-weight: 600; margin-bottom: 0.5rem; display:flex; align-items:center; gap:0.5rem;">
                ...
                Struktur Berkas Halaman Tambah
            </div>
            <div style="margin-bottom:0.25rem;"><strong>File View:</strong> <span class="mvc-code">resources/views/pengaturan/pengguna/create.blade.php</span></div>
            <div><strong>Controller:</strong> <span class="mvc-code">UserController@create</span> &amp; <span class="mvc-code">UserController@store</span></div>
        </div>
