    ...
    <div class="ht-wrap" style="padding:24px">
        ...
        <div class="ht-header">
            <div class="ht-header-left">
                ...
                <div>
                    <h1>Daftar Piutang Aktif</h1>
                    <p>Monitoring tagihan dan piutang pelanggan gula</p>
                </div>
            </div>
        ...
        {{-- Filter --}}
        <div class="ht-filter">
            <form method="GET" action="{{ route('gula.hutang.piutang') }}">
                ...
                <a href="{{ route('gula.hutang.piutang') }}" class="ht-btn-reset">
