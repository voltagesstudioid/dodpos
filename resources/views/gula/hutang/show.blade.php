<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('gula.hutang.index') }}" class="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 transition-colors">
    ...
    <style>
        ...
        .hs-fi:focus { outline:none; border-color:#f59e0b; box-shadow:0 0 0 3px rgba(245,158,11,.12); }
        ...
        .hs-btn-primary { background:linear-gradient(135deg,#f59e0b,#d97706); color:#fff; box-shadow:0 4px 16px rgba(217,119,6,.3); }
        .hs-btn-primary:hover { transform:translateY(-1px); box-shadow:0 6px 20px rgba(217,119,6,.4); }
        .hs-btn-primary:disabled { opacity:.6; cursor:not-allowed; transform:none; }

        .hs-transfer-fields { border:1.5px solid #fde68a; border-radius:14px; padding:1rem; background:#fffbeb; margin-bottom:1rem; }
        .hs-transfer-fields .hs-fl { color:#92400e; }
        ...
        <div class="hs-grid">
            ...
            <div>
                ...
                <div class="hs-card">
                    ...
                    @endphp
                    <div class="hs-card-hdr" style="background:linear-gradient(135deg,{{ $isLunas ? '#ecfdf5,#f0fdf4' : ($isOverdue ? '#fef2f2,#fff1f2' : '#fffbeb,#fef9ee') }});">
                            ...
                            <table class="hs-tbl">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span style="text-transform:capitalize; font-weight:600;">{{ $bayar->cara_bayar }}</span></td>
                                        <td>
                                        ...
                                        <td>
                                            @if($bayar->status === 'pending')
                                                <div style="display:flex; gap:4px;">
                                                    <form action="{{ route('gula.hutang.confirm-payment', [$hutang, $bayar]) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                ...
                                                <div id="reject-{{ $bayar->id }}" style="display:none; margin-top:6px; padding:8px; background:#fef2f2; border:1px solid #fecaca; border-radius:10px;">
                                                    <form action="{{ route('gula.hutang.reject-payment', [$hutang, $bayar]) }}" method="POST">
                                                        @csrf
            ...
            <div>
                @if($hutang->status !== 'lunas' && (float) $hutang->sisa > 0)
                    ...
                    @endphp
                    <div class="hs-card">
                        <div class="hs-card-hdr" style="background:linear-gradient(135deg,#fffbeb,#fef3c7);">
                            <div class="hs-card-ico" style="background:linear-gradient(135deg,#f59e0b,#d97706);">
                        ...
                        <div class="hs-card-body">
                            ...
                            @else
                            <form action="{{ route('gula.hutang.bayar', $hutang) }}" method="POST" enctype="multipart/form-data" id="form-bayar">
                                @csrf
                                <div class="hs-fg">
                                ...
                                <div id="transfer-fields" style="display:none;">
                                    <div class="hs-transfer-fields">
                                        <div class="hs-fg" style="margin-bottom:.75rem;">
                                            <label class="hs-fl">
                                                <svg width="14" height="14" fill="none" stroke="#92400e" viewBox="0 0 24 24" style="display:inline;vertical-align:-2px;margin-right:2px;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14"/></svg>
                                        ...
                                        <div class="hs-fg" style="margin-bottom:0;">
                                            <label class="hs-fl">
                                                <svg width="14" height="14" fill="none" stroke="#92400e" viewBox="0 0 24 24" style="display:inline;vertical-align:-2px;margin-right:2px;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                ...
                <a href="{{ route('gula.hutang.index') }}" class="hs-btn" style="background:#f1f5f9; color:#475569; margin-top:.75rem; text-decoration:none;">
