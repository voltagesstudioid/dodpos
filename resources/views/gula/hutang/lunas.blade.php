    ...
    <div class="ht-wrap" style="padding:24px">
        ...
        <div class="ht-header">
            <div class="ht-header-left">
                ...
                <div>
                    <h1>Riwayat Hutang Lunas</h1>
                    <p>Arsip dan riwayat pembayaran pelanggan gula yang sudah lunas</p>
                </div>
            </div>
        ...
        {{-- Filter --}}
        <div class="ht-filter">
            <form method="GET" action="{{ route('gula.hutang.lunas') }}">
                ...
                <a href="{{ route('gula.hutang.lunas') }}" class="ht-btn-reset">
