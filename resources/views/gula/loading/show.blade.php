<x-app-layout>
    ...
    <style>
        ...
        .ds-back-btn:hover { background:#f8fafc; border-color:#cbd5e1; color:#d97706; transform:translateX(-2px); }
        ...
        .ds-btn-edit { background:linear-gradient(135deg,#f59e0b,#d97706); color:#fff; box-shadow:0 4px 14px rgba(217,119,6,0.25); }
        .ds-btn-edit:hover { transform:translateY(-1px); box-shadow:0 8px 24px rgba(217,119,6,0.35); }
    ...
    <div class="ds-page">
        ...
        {{-- Breadcrumb --}}
        <nav class="ds-nav">
            <a href="{{ route('gula.loading.index') }}" class="ds-back-btn">
            ...
            <div class="ds-card-body">
                <div class="ds-grid3">
                    <div class="ds-item">
                        ...
                        <span class="ds-val mono" style="color:#2563eb;">{{ number_format($loading->jumlah_loading) }} {{ $loading->produk->satuan ?? 'Dus' }}</span>
                    </div>
                    <div class="ds-item">
                        <span class="ds-lbl">Terjual</span>
                        <span class="ds-val mono" style="color:#059669;">{{ number_format($loading->terjual) }} {{ $loading->produk->satuan ?? 'Dus' }}</span>
                    </div>
                    <div class="ds-item">
                        <span class="ds-lbl">Sisa Stok</span>
                        <span class="ds-val mono" style="color:#d97706;">{{ number_format($loading->sisa_stok) }} {{ $loading->produk->satuan ?? 'Dus' }}</span>
                    </div>
                </div>
        ...
        <div class="ds-actions">
            <a href="{{ route('gula.loading.index') }}" class="ds-btn ds-btn-back">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 18-6-6 6-6"/></svg>
                Kembali
            </a>
            <a href="{{ route('gula.loading.edit', $loading->id) }}" class="ds-btn ds-btn-edit">
