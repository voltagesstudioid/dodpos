...
@section('title', 'Tambah Loading')
@section('page-title', 'Tambah Loading')
...
<div class="glc-page">
    <div class="glc-header">
        <div class="glc-header-top">
            <div class="glc-header-left">
                <a href="{{ route('gula.loading.index') }}" class="glc-back">
                ...
                <div class="glc-header-title">
                    <h1>Tambah Loading</h1>
                    <p>Distribusi gula ke kendaraan sales</p>
                </div>
            </div>
    ...
    <form action="{{ route('gula.loading.store') }}" method="POST" class="glc-form">
        @csrf
        ...
        <div class="glc-card">
            <div class="glc-card-head amber">
                ...
                <div class="glc-card-head-text">
                    ...
                    <p>Data distribusi gula ke sales untuk hari ini</p>
                </div>
            </div>
                    ...
                    <div class="glc-field">
                        ...
                        <select name="produk_id" id="sel-produk" required>
                            ...
                            @foreach($produks as $p)
                                <option value="{{ $p->id }}" data-satuan="{{ $p->satuan }}" {{ old('produk_id') == $p->id ? 'selected' : '' }}>
                ...
                <div class="glc-row full">
                    <div class="glc-field">
                        <label>
                            ...
                            Jumlah Loading <span class="req" id="qty-label">*</span>
                        </label>
                        <div class="glc-qty-wrap">
                            <input type="number" name="jumlah_loading" value="{{ old('jumlah_loading') }}" required min="1" placeholder="Contoh: 500" class="mono">
            ...
            <div class="glc-card-body">
                <div class="glc-row full">
                    <div class="glc-field">
                        ...
                        <textarea name="keterangan" rows="4" placeholder="Catatan tambahan (opsional)..." style="resize: none;">{{ old('keterangan') }}</textarea>
        ...
        <div class="glc-actions">
            ...
            <a href="{{ route('gula.loading.index') }}" class="glc-btn-cancel">
...
(function() {
    ...
    // Init on load if a product is already selected
