<x-app-layout>
    ...
    <div x-data="masterProdukApp()" class="page-container">
        ...
        {{-- ══════ MODAL: PRODUK ADD ══════ --}}
        <div class="modal-overlay" x-show="modals['produk-add']" x-cloak
             @keydown.escape.window="modals['produk-add']=false"
             @click.self="modals['produk-add']=false"
             x-transition:enter.opacity.duration.200ms>
            <div class="modal modal-wide" @click.stop>
                <form @submit.prevent="submitProduk($event, 'add')">
                    @csrf
                    <div class="modal-header">
                        <div class="modal-title">✦ Tambah Produk Baru</div>
                        <button type="button" class="modal-close" @click="modals['produk-add']=false">&times;</button>
                    </div>
                    <div class="modal-body">
                            ...
                            <div class="form-card-body">
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-input" required placeholder="Coca-Cola 250ml" x-ref="produkName">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">SKU <span class="form-hint" style="display:inline;font-weight:400;">(kosongkan utk auto)</span></label>
                                        <input type="text" name="sku" class="form-input" placeholder="Otomatis jika dikosongkan">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Barcode</label>
                                    <input type="text" name="barcode" class="form-input" placeholder="Opsional">
                                    <div class="form-hint">Scan barcode produk jika tersedia</div>
                                </div>
                            </div>
                        </div>
                        <div class="form-card">
                            ...
                            <div class="form-card-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-hint">Satuan terkecil untuk stok</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-card-body">
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" class="form-input" required min="0" step="0.01" placeholder="0">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Harga Beli</label>
                                        <input type="number" name="purchase_price" class="form-input" min="0" step="0.01" placeholder="0">
                                        <div class="form-hint">Modal awal produk</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-card-body">
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="stock" class="form-input" min="0" step="0.01" placeholder="0">
                                        <div class="form-hint">Stok awal di gudang utama</div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Min. Stok</label>
                                        <input type="number" name="min_stock" class="form-input" min="0" step="0.01" placeholder="0">
                                        <div class="form-hint">Peringatan jika stok di bawah jumlah ini</div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-card">
                            ...
                            <div class="form-card-body">
                                <div class="form-hint" style="margin-bottom:.75rem;">Tambahkan satuan lain (misal: dus, karton) dengan harga masing-masing</div>
                                <template x-for="(row, idx) in unitRows" :key="idx">
                                    <div class="unit-grid">
                                        <div class="form-group">
                                            <label class="unit-grid-label">Satuan</label>
                                            <select :name="`units[${idx}][unit_id]`" class="form-input" x-model="row.unit_id" style="height:36px;font-size:.8125rem;">
                                        ...
                                        <div class="form-group">
                                            <label class="unit-grid-label">Faktor</label>
                                            <input type="number" :name="`units[${idx}][conversion_factor]`" class="form-input" x-model="row.factor" style="height:36px;font-size:.8125rem;" min="0.0001" step="0.0001" placeholder="1">
                                        </div>
                                        <div class="form-group">
                                            <label class="unit-grid-label">Beli</label>
                                            <input type="number" :name="`units[${idx}][purchase_price]`" class="form-input" x-model="row.beli" style="height:36px;font-size:.8125rem;" min="0" step="0.01" placeholder="0">
                                        </div>
                                        <div class="form-group">
                                            <label class="unit-grid-label">Ecer</label>
                                            <input type="number" :name="`units[${idx}][sell_price_ecer]`" class="form-input" x-model="row.ecer" style="height:36px;font-size:.8125rem;" min="0" step="0.01" placeholder="0">
                                        </div>
                                        <div class="form-group">
                                            <label class="unit-grid-label">Grosir</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondary" @click="modals['produk-add']=false">Batal</button>
        ...
        {{-- ══════ MODAL: PRODUK EDIT ══════ --}}
        <div class="modal-overlay" x-show="modals['produk-edit']" x-cloak
             @keydown.escape.window="modals['produk-edit']=false"
             @click.self="modals['produk-edit']=false"
             x-transition:enter.opacity.duration.200ms>
            <div class="modal modal-wide" @click.stop>
                <form @submit.prevent="submitProduk($event, 'edit')">
                    @csrf
                    <input type="hidden" name="_method" value="PUT">
                    <div class="modal-header">
                        <div class="modal-title">✦ Edit Produk</div>
                        <button type="button" class="modal-close" @click="modals['produk-edit']=false">&times;</button>
                    </div>
                    <div class="modal-body">
                        <template x-if="editProduk">
                            <div>
                                <div class="form-card">
                                    <div class="form-card-header">
                                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                                    ...
                                    <div class="form-card-body">
                                        <div class="form-row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-input" required x-model="editProduk.name">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">SKU <span class="required">*</span></label>
                                                <input type="text" name="sku" class="form-input" required x-model="editProduk.sku">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Barcode</label>
                                            <input type="text" name="barcode" class="form-input" x-model="editProduk.barcode">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-card">
                                    ...
                                    <div class="form-card-body">
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label class="form-label">Kategori <span class="required">*</span></label>
                                                <select name="category_id" class="form-input" required x-model.number="editProduk.category_id">
                                                    <option value="">Pilih kategori</option>
                                                    @foreach($categories as $cat)
                                                        <option value="{{ $cat->id }}">{{ $cat->name }}</option>
                                                    @endforeach
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Satuan Dasar</label>
                                                <select name="unit_id" class="form-input" x-model.number="editProduk.unit_id">
                                                    <option value="">Pilih satuan</option>
                                                    @foreach($units as $u)
                                                        <option value="{{ $u->id }}">{{ $u->name }} ({{ $u->abbreviation }})</option>
                                                    @endforeach
                                ...
                                <div class="form-card">
                                    ...
                                    <div class="form-card-body">
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label class="form-label">Harga Jual <span class="required">*</span></label>
                                                <input type="number" name="price" class="form-input" required min="0" step="0.01" x-model="editProduk.price">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Harga Beli</label>
                                                <input type="number" name="purchase_price" class="form-input" min="0" step="0.01" x-model="editProduk.purchase_price">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-card">
                                    ...
                                    <div class="form-card-body">
                                        <div class="form-row">
                                            <div class="form-group">
                                                <label class="form-label">Min. Stok</label>
                                                <input type="number" name="min_stock" class="form-input" min="0" step="0.01" x-model="editProduk.min_stock">
                                                <div class="form-hint">Peringatan jika stok di bawah jumlah ini</div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">&nbsp;</label>
                                                <div style="padding:0.5rem 0;color:#64748b;font-size:0.8125rem;">Stok diatur via tab <strong>Stok</strong> (Penyesuaian Stok)</div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Deskripsi</label>
                                            <textarea name="description" class="form-input" rows="2" x-model="editProduk.description"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-card">
                                    ...
                                    <div class="form-card-body">
                                        <template x-for="(row, idx) in editUnitRows" :key="'eu-'+idx">
                                            <div class="unit-grid">
                                                <div class="form-group">
                                                    <label class="unit-grid-label">Satuan</label>
                                                    <select :name="`units[${idx}][unit_id]`" class="form-input" x-model.number="row.unit_id" style="height:36px;font-size:.8125rem;">
                                                        <option value="">Pilih</option>
                                                        @foreach($units as $u)
                                                        <option :value="{{ $u->id }}">{{ $u->name }}</option>
                                                        @endforeach
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn-secondary" @click="modals['produk-edit']=false">Batal</button>
                        <button type="submit" class="btn-primary" :disabled="submitting" x-text="submitting ? 'Menyimpan...' : 'Simpan'"></button>
                    </div>
                </form>
            </div>
