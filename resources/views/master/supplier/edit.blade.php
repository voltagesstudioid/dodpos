<x-app-layout>
    ...
    <div class="page-container animate-in" style="max-width:1100px;">
        <div class="page-header">
            <div>
                <div class="page-header-title">Edit Supplier</div>
                <div class="page-header-subtitle">Perbarui data supplier untuk kebutuhan pembelian.</div>
            </div>
            <div class="page-header-actions">
                <a href="{{ route('master.supplier') }}" class="btn-secondary">← Kembali</a>
                <button type="submit" form="supplierEditForm" class="btn-primary">💾 Simpan Perubahan</button>
            </div>
        </div>
        ...
        <form id="supplierEditForm" method="POST" action="{{ route('master.supplier.update', $supplier) }}">
            @csrf @method('PUT')
            ...
            <div class="supplier-grid">
                <div class="card supplier-card">
                    <div class="supplier-card-head">
                        ...
                        <div style="min-width:0;">
                            ...
                            <div class="supplier-card-sub">Data utama supplier</div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Kode Supplier (Opsional)</label>
                        <input type="text" name="code" value="{{ old('code', $supplier->code) }}"
                            class="form-input @error('code') input-error @enderror" placeholder="SUP-001">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" rows="3" class="form-input @error('address') input-error @enderror">{{ old('address', $supplier->address) }}</textarea>
                ...
                <div class="card supplier-card">
                    <div class="supplier-card-head">
                        ...
                        <div style="min-width:0;">
                            ...
                            <div class="supplier-card-sub">Informasi kontak PIC</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="contact_person" value="{{ old('contact_person', $supplier->contact_person) }}"
                            class="form-input @error('contact_person') input-error @enderror">
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <textarea name="notes" rows="3" class="form-input @error('notes') input-error @enderror">{{ old('notes', $supplier->notes) }}</textarea>
                ...
                <div class="card supplier-card">
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <input type="number" name="term_days" value="{{ old('term_days', $supplier->term_days) }}" min="0"
