<x-hr-layout>
    ...
    <x-slot name="actions">
        ...
        <form action="{{ route('sdm.absensi.sync') }}" method="POST" style="display:inline;">
            @csrf
            <button type="submit" class="att-hbtn" style="background:linear-gradient(135deg,#10b981,#059669);color:#fff;">
