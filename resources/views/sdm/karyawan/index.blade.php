        ...
        <div class="tr-page">
            ...
            <div class="tr-header">
                <div class="tr-header-text">
                    <div class="tr-eyebrow">Manajemen Personalia</div>
                    <h1 class="tr-title">
                    ...
                    <p class="tr-subtitle">Kelola data profil, jabatan, dan akses *login* sistem (akun) untuk seluruh karyawan.</p>
                </div>
                ...
                <div class="tr-header-actions">
                    ...
                    @can('create_karyawan')
                    <form method="POST" action="{{ route('sdm.karyawan.import') }}" style="margin:0;">
                        @csrf
                        <button type="submit" class="tr-btn tr-btn-outline" title="Sinkronkan data dari tabel pengguna">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.59-10.09l5.25 5.25"></path></svg>
                            Impor Akun
                        </button>
                    </form>
