<x-app-layout>
    ...
    <style>
        ...
        .ci-hdr {
            ...
            box-shadow:0 12px 40px rgba(79,70,229,0.25); position:relative; overflow:hidden;
        }
        ...
        .ci-card-ico.indigo { background:linear-gradient(135deg,#eef2ff,#e0e7ff); }
        ...
        .ci-sel:focus { border-color:#6366f1; box-shadow:0 0 0 3px rgba(99,102,241,0.12); }
        .ci-textarea {
            width:100%; padding:0.75rem 0.875rem; border-radius:10px; border:1.5px solid #e2e8f0;
            background:#fff; font-size:0.875rem; color:#1e293b; outline:none; transition:all 0.2s;
            font-family:inherit; resize:vertical; min-height:3.5rem;
        }
        .ci-textarea:focus { border-color:#6366f1; box-shadow:0 0 0 3px rgba(99,102,241,0.12); }
        ...
        .ci-camera-btn {
            ...
            border:1.5px solid #c7d2fe; cursor:pointer; transition:all 0.2s; font-family:inherit;
            background:#eef2ff; color:#4338ca; margin-top:0.75rem;
        }
        .ci-camera-btn:hover { background:#e0e7ff; border-color:#a5b4fc; }
        ...
        .ci-btn-submit:hover { transform:translateY(-2px); box-shadow:0 12px 36px rgba(79,70,229,0.4); }
        ...
        .ci-alert-warning { background:#fffbeb; color:#92400e; border:1px solid #fde68a; }
    ...
    <div class="ci-page">
        {{-- Back --}}
        <a href="{{ route('minyak.kunjungan.index') }}" class="ci-back">
        ...
        @if($activeVisit)
            <div class="ci-active">
                ...
                <a href="{{ route('minyak.kunjungan.show', $activeVisit) }}" class="ci-active-link">
        ...
        <form method="POST" action="{{ route('minyak.kunjungan.checkin.store') }}" enctype="multipart/form-data" id="form-checkin">
            @csrf

            {{-- Pilih Pelanggan --}}
            <div class="ci-card">
                <div class="ci-card-hdr">
                    <div class="ci-card-ico indigo">🏪</div>
            ...
            <div class="ci-card">
                <div class="ci-card-hdr">
                    <div class="ci-card-ico green">📍</div>
            ...
            <div class="ci-card">
                <div class="ci-card-hdr">
                    <div class="ci-card-ico amber">📸</div>
                    <div class="ci-card-lbl">Foto Kunjungan</div>
                </div>
                <div class="ci-card-body">
                    {{-- Hidden file input for mobile native camera --}}
                    <input type="file" name="foto" id="foto-input" accept="image/*" capture="user" style="display:none;">
                    {{-- Hidden input to hold base64 data from desktop webcam --}}
            ...
            <div class="ci-submit-bar">
                <a href="{{ route('minyak.kunjungan.index') }}" class="ci-btn-cancel">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Button: Ambil Foto (desktop capture from webcam)
        ...
        // Mobile: photo preview on file input change
