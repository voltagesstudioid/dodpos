<x-app-layout>
    ...
    <style>
        ...
        .pcf-kode {
            ...
            margin-top:0.375rem; border:1px solid #fde68a;
        }
        ...
        .pcf-card-hdr-ico.green { background:linear-gradient(135deg,#10b981,#059669); color:#fff; }
        .pcf-card-hdr-ico.purple { background:linear-gradient(135deg,#8b5cf6,#7c3aed); color:#fff; }
        .pcf-card-hdr-ico.pink { background:linear-gradient(135deg,#ec4899,#db2777); color:#fff; }
        ...
        .pcf-tip {
            ...
            padding:0.875rem 1rem; border-radius:12px; margin-bottom:1.25rem;
            background:linear-gradient(135deg,#fffbeb,#fef3c7); border:1px solid #fde68a;
        }
        .pcf-tip-ico { color:#d97706; flex-shrink:0; margin-top:1px; }
        .pcf-tip-text { font-size:0.75rem; color:#92400e; line-height:1.5; }

        /* Photo Preview */
        .pcf-photo-current {
            max-width:200px; max-height:150px; border-radius:12px; border:2px solid #e2e8f0;
    ...
    <div class="py-4">
        <div class="pcf-page">
            ...
            <div class="pcf-hdr">
                ...
                <div>
                    <div class="pcf-hdr-title">Edit Pelanggan</div>
                    <div class="pcf-hdr-sub">Ubah data pelanggan modul minyak</div>
                    <div class="pcf-kode">
            ...
            <form method="POST" action="{{ route('minyak.pelanggan.update', $pelanggan) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                {{-- Tip --}}
                <div class="pcf-tip">
                    <svg class="pcf-tip-ico" width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    ...
                    <div class="pcf-card-body">
                        <div class="pcf-grid">
                            <div>
                                ...
                                <input type="text" name="nama_toko" value="{{ old('nama_toko', $pelanggan->nama_toko) }}" required placeholder="Masukkan nama toko" class="pcf-input">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama_pemilik" value="{{ old('nama_pemilik', $pelanggan->nama_pemilik) }}" required placeholder="Masukkan nama pemilik" class="pcf-input">
                            ...
                            <div>
                                ...
                                <input type="text" name="no_hp" value="{{ old('no_hp', $pelanggan->no_hp) }}" placeholder="Contoh: 08123456789" class="pcf-input">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email', $pelanggan->email) }}" placeholder="Contoh: toko@email.com" class="pcf-input">
                ...
                <div class="pcf-card">
                    <div class="pcf-card-hdr green">
                        <div class="pcf-card-hdr-ico green">📍</div>
                        <div>
                            <div class="pcf-card-hdr-title">Informasi Lokasi</div>
                            <div class="pcf-card-hdr-desc">Alamat dan koordinat toko pelanggan</div>
                        </div>
                    </div>
                    <div class="pcf-card-body">
                        <div class="pcf-grid">
                            <div class="pcf-full">
                                <label class="pcf-lbl">Alamat Lengkap <span class="pcf-req">*</span></label>
                                <textarea name="alamat" rows="3" placeholder="Jl. Contoh No. 123, RT/RW" class="pcf-input" required>{{ old('alamat', $pelanggan->alamat) }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" name="kecamatan" value="{{ old('kecamatan', $pelanggan->kecamatan) }}" placeholder="Nama kecamatan" class="pcf-input" required list="list-kecamatan">
                            ...
                            <div>
                                <label class="pcf-lbl">Kota / Kabupaten <span class="pcf-req">*</span></label>
                                <input type="text" name="kota" value="{{ old('kota', $pelanggan->kota) }}" placeholder="Nama kota" class="pcf-input" required list="list-kota">
                            ...
                            <div>
                                ...
                                <select name="provinsi" class="pcf-input">
                                    ...
                                    <option value="Aceh" {{ old('provinsi', $pelanggan->provinsi) == 'Aceh' ? 'selected' : '' }}>Aceh</option>
                                    <option value="Sumatera Utara" {{ old('provinsi', $pelanggan->provinsi) == 'Sumatera Utara' ? 'selected' : '' }}>Sumatera Utara</option>
                                    <option value="Sumatera Barat" {{ old('provinsi', $pelanggan->provinsi) == 'Sumatera Barat' ? 'selected' : '' }}>Sumatera Barat</option>
                                    <option value="Riau" {{ old('provinsi', $pelanggan->provinsi) == 'Riau' ? 'selected' : '' }}>Riau</option>
                                    <option value="Kepulauan Riau" {{ old('provinsi', $pelanggan->provinsi) == 'Kepulauan Riau' ? 'selected' : '' }}>Kepulauan Riau</option>
                                    <option value="Jambi" {{ old('provinsi', $pelanggan->provinsi) == 'Jambi' ? 'selected' : '' }}>Jambi</option>
                                    <option value="Sumatera Selatan" {{ old('provinsi', $pelanggan->provinsi) == 'Sumatera Selatan' ? 'selected' : '' }}>Sumatera Selatan</option>
                                    <option value="Bangka Belitung" {{ old('provinsi', $pelanggan->provinsi) == 'Bangka Belitung' ? 'selected' : '' }}>Bangka Belitung</option>
                                    <option value="Bengkulu" {{ old('provinsi', $pelanggan->provinsi) == 'Bengkulu' ? 'selected' : '' }}>Bengkulu</option>
                                    <option value="Lampung" {{ old('provinsi', $pelanggan->provinsi) == 'Lampung' ? 'selected' : '' }}>Lampung</option>
                                    <option value="Banten" {{ old('provinsi', $pelanggan->provinsi) == 'Banten' ? 'selected' : '' }}>Banten</option>
                                    <option value="DKI Jakarta" {{ old('provinsi', $pelanggan->provinsi) == 'DKI Jakarta' ? 'selected' : '' }}>DKI Jakarta</option>
                                    <option value="Jawa Barat" {{ old('provinsi', $pelanggan->provinsi) == 'Jawa Barat' ? 'selected' : '' }}>Jawa Barat</option>
                                    <option value="Jawa Tengah" {{ old('provinsi', $pelanggan->provinsi) == 'Jawa Tengah' ? 'selected' : '' }}>Jawa Tengah</option>
                                    <option value="DI Yogyakarta" {{ old('provinsi', $pelanggan->provinsi) == 'DI Yogyakarta' ? 'selected' : '' }}>DI Yogyakarta</option>
                                    <option value="Jawa Timur" {{ old('provinsi', $pelanggan->provinsi) == 'Jawa Timur' ? 'selected' : '' }}>Jawa Timur</option>
                                    <option value="Bali" {{ old('provinsi', $pelanggan->provinsi) == 'Bali' ? 'selected' : '' }}>Bali</option>
                                    <option value="Nusa Tenggara Barat" {{ old('provinsi', $pelanggan->provinsi) == 'Nusa Tenggara Barat' ? 'selected' : '' }}>Nusa Tenggara Barat</option>
                                    <option value="Nusa Tenggara Timur" {{ old('provinsi', $pelanggan->provinsi) == 'Nusa Tenggara Timur' ? 'selected' : '' }}>Nusa Tenggara Timur</option>
                                    <option value="Kalimantan Barat" {{ old('provinsi', $pelanggan->provinsi) == 'Kalimantan Barat' ? 'selected' : '' }}>Kalimantan Barat</option>
                                    <option value="Kalimantan Tengah" {{ old('provinsi', $pelanggan->provinsi) == 'Kalimantan Tengah' ? 'selected' : '' }}>Kalimantan Tengah</option>
                                    <option value="Kalimantan Selatan" {{ old('provinsi', $pelanggan->provinsi) == 'Kalimantan Selatan' ? 'selected' : '' }}>Kalimantan Selatan</option>
                                    <option value="Kalimantan Timur" {{ old('provinsi', $pelanggan->provinsi) == 'Kalimantan Timur' ? 'selected' : '' }}>Kalimantan Timur</option>
                                    <option value="Kalimantan Utara" {{ old('provinsi', $pelanggan->provinsi) == 'Kalimantan Utara' ? 'selected' : '' }}>Kalimantan Utara</option>
                                    <option value="Sulawesi Utara" {{ old('provinsi', $pelanggan->provinsi) == 'Sulawesi Utara' ? 'selected' : '' }}>Sulawesi Utara</option>
                                    <option value="Sulawesi Tengah" {{ old('provinsi', $pelanggan->provinsi) == 'Sulawesi Tengah' ? 'selected' : '' }}>Sulawesi Tengah</option>
                                    <option value="Sulawesi Selatan" {{ old('provinsi', $pelanggan->provinsi) == 'Sulawesi Selatan' ? 'selected' : '' }}>Sulawesi Selatan</option>
                                    <option value="Sulawesi Tenggara" {{ old('provinsi', $pelanggan->provinsi) == 'Sulawesi Tenggara' ? 'selected' : '' }}>Sulawesi Tenggara</option>
                                    <option value="Gorontalo" {{ old('provinsi', $pelanggan->provinsi) == 'Gorontalo' ? 'selected' : '' }}>Gorontalo</option>
                                    <option value="Sulawesi Barat" {{ old('provinsi', $pelanggan->provinsi) == 'Sulawesi Barat' ? 'selected' : '' }}>Sulawesi Barat</option>
                                    <option value="Maluku" {{ old('provinsi', $pelanggan->provinsi) == 'Maluku' ? 'selected' : '' }}>Maluku</option>
                                    <option value="Maluku Utara" {{ old('provinsi', $pelanggan->provinsi) == 'Maluku Utara' ? 'selected' : '' }}>Maluku Utara</option>
                                    <option value="Papua" {{ old('provinsi', $pelanggan->provinsi) == 'Papua' ? 'selected' : '' }}>Papua</option>
                                    <option value="Papua Barat" {{ old('provinsi', $pelanggan->provinsi) == 'Papua Barat' ? 'selected' : '' }}>Papua Barat</option>
                                    <option value="Papua Selatan" {{ old('provinsi', $pelanggan->provinsi) == 'Papua Selatan' ? 'selected' : '' }}>Papua Selatan</option>
                                    <option value="Papua Tengah" {{ old('provinsi', $pelanggan->provinsi) == 'Papua Tengah' ? 'selected' : '' }}>Papua Tengah</option>
                                    <option value="Papua Pegunungan" {{ old('provinsi', $pelanggan->provinsi) == 'Papua Pegunungan' ? 'selected' : '' }}>Papua Pegunungan</option>
                                    <option value="Papua Barat Daya" {{ old('provinsi', $pelanggan->provinsi) == 'Papua Barat Daya' ? 'selected' : '' }}>Papua Barat Daya</option>
                                </select>
                            </div>
                            <div>
                                <label class="pcf-lbl">Latitude</label>
                                <input type="text" name="latitude" id="inp-lat" value="{{ old('latitude', $pelanggan->latitude) }}" placeholder="-6.20880000" class="pcf-input" readonly>
                            </div>
                            <div>
                                <label class="pcf-lbl">Longitude</label>
                                <input type="text" name="longitude" id="inp-lng" value="{{ old('longitude', $pelanggan->longitude) }}" placeholder="106.84560000" class="pcf-input" readonly>
                            </div>
                            <div class="pcf-full">
                                ...
                                <div style="font-size:0.6875rem; color:#94a3b8; margin-top:0.5rem; line-height:1.6;">
                                    📱 Koordinat saat ini tersimpan. Klik "Deteksi Ulang" untuk memperbarui dari lokasi Anda saat ini.<br>
                ...
                <div class="pcf-card">
                    <div class="pcf-card-hdr pink">
                        <div class="pcf-card-hdr-ico pink">📸</div>
                        <div>
                            <div class="pcf-card-hdr-title">Foto Toko</div>
                            <div class="pcf-card-hdr-desc">Ambil foto baru untuk mengganti foto lama</div>
                        </div>
                    </div>
                    <div class="pcf-card-body">
                        ...
                        <div class="pcf-grid" style="gap:1rem;">
                            <div>
                                ...
                                <div style="text-align:center; margin-bottom:0.5rem;">
                                    <img src="{{ asset('storage/' . $pelanggan->foto_toko) }}" alt="Foto Depan" style="max-width:100%; max-height:150px; border-radius:10px; border:2px solid #e2e8f0; object-fit:cover;">
                                </div>
                                @endif
                                <div id="preview-depan-wrap" style="text-align:center; margin-bottom:0.5rem;">
                                    <img id="preview-depan" src="" alt="Preview Depan" style="display:none; max-width:100%; max-height:150px; border-radius:10px; border:2px solid #e2e8f0;">
                                </div>
                            ...
                            <div>
                                ...
                                <div style="text-align:center; margin-bottom:0.5rem;">
                                    <img src="{{ asset('storage/' . $pelanggan->foto_toko_dalam) }}" alt="Foto Dalam" style="max-width:100%; max-height:150px; border-radius:10px; border:2px solid #e2e8f0; object-fit:cover;">
                                </div>
                                @endif
                                <div id="preview-dalam-wrap" style="text-align:center; margin-bottom:0.5rem;">
                                    <img id="preview-dalam" src="" alt="Preview Dalam" style="display:none; max-width:100%; max-height:150px; border-radius:10px; border:2px solid #e2e8f0;">
                                </div>
                    ...
                    <div class="pcf-card-body">
                        ...
                        <select name="regional_id" class="pcf-input" style="margin-bottom:1.25rem;">
                            ...
                            @foreach($regionals as $regional)
                                <option value="{{ $regional->id }}" {{ old('regional_id', $pelanggan->regional_id) == $regional->id ? 'selected' : '' }}>{{ $regional->nama }}</option>
                            @endforeach
                        </select>
                        ...
                        <div class="pcf-radios">
                            <label class="pcf-radio blue">
                                <input type="radio" name="tipe" value="eceran" {{ old('tipe', $pelanggan->tipe) == 'eceran' ? 'checked' : '' }} required>
                            ...
                            <label class="pcf-radio purple">
                                <input type="radio" name="tipe" value="grosir" {{ old('tipe', $pelanggan->tipe) == 'grosir' ? 'checked' : '' }}>
                                <span class="pcf-radio-dot"></span>
                                <div>
                            ...
                            <label class="pcf-radio orange">
                                <input type="radio" name="tipe" value="agen" {{ old('tipe', $pelanggan->tipe) == 'agen' ? 'checked' : '' }}>
                                <span class="pcf-radio-dot"></span>
                                <div>
                        ...
                        <div class="pcf-money-wrap">
                            ...
                            <input type="text" inputmode="numeric" name="limit_hutang" id="limitHutang" value="{{ old('limit_hutang', $pelanggan->limit_hutang) }}" placeholder="0" class="pcf-input" data-currency>
                        </div>
                        <div class="pcf-help">
                        ...
                        <div class="pcf-radios">
                            <label class="pcf-radio green">
                                <input type="radio" name="status" value="aktif" {{ old('status', $pelanggan->status) == 'aktif' ? 'checked' : '' }} required>
                                <span class="pcf-radio-dot"></span>
                                <div>
                            ...
                            <label class="pcf-radio gray">
                                <input type="radio" name="status" value="nonaktif" {{ old('status', $pelanggan->status) == 'nonaktif' ? 'checked' : '' }}>
                                <span class="pcf-radio-dot"></span>
                                <div>
                            ...
                            <label class="pcf-radio red">
                                <input type="radio" name="status" value="blacklist" {{ old('status', $pelanggan->status) == 'blacklist' ? 'checked' : '' }}>
                                <span class="pcf-radio-dot"></span>
                                <div>
