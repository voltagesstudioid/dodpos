            ...
            <form method="POST" action="{{ route('minyak.pelanggan.update', $pelanggan) }}" enctype="multipart/form-data">
                ...
                <div class="pcf-card">
                    ...
                    <div class="pcf-card-body">
                        <div class="pcf-grid">
                            <div class="pcf-full">
                                <label class="pcf-lbl">Alamat Lengkap</label>
                                <textarea name="alamat" rows="3" placeholder="Jl. Contoh No. 123, RT/RW" class="pcf-input">{{ old('alamat', $pelanggan->alamat) }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="text" name="kecamatan" value="{{ old('kecamatan', $pelanggan->kecamatan) }}" placeholder="Nama kecamatan" class="pcf-input">
                            </div>
                            <div>
                                <label class="pcf-lbl">Kota / Kabupaten</label>
                ...
                <div class="pcf-card">
                    <div class="pcf-card-hdr pink">
                        ...
                        <div>
                            ...
                            <div class="pcf-card-hdr-desc">Upload foto baru untuk mengganti foto lama</div>
                        </div>
                    </div>
                    <div class="pcf-card-body">
                        @if($pelanggan->foto_toko)
                        <div style="margin-bottom:1rem;">
                            <div style="font-size:0.75rem; font-weight:600; color:#64748b; margin-bottom:0.5rem; text-transform:uppercase; letter-spacing:0.05em;">Foto Saat Ini</div>
                            <img src="{{ asset('storage/' . $pelanggan->foto_toko) }}" alt="Foto Toko" class="pcf-photo-current">
                        </div>
                        @endif
                ...
                <div class="pcf-card">
                    ...
                    <div class="pcf-card-body">
                        ...
                        <div class="pcf-money-wrap">
                            ...
                            <input type="number" name="limit_hutang" id="limitHutang" value="{{ old('limit_hutang', $pelanggan->limit_hutang) }}" placeholder="0" class="pcf-input">
                        </div>
                        <div class="pcf-help">
