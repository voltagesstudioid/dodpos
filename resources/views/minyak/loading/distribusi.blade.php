<x-app-layout>
    ...
    <style>
        ...
        .ds-card-hdr { padding:1rem 1.25rem; border-bottom:1px solid #fef9e7; display:flex; align-items:center; gap:.625rem; background:linear-gradient(180deg,#fffbeb,#fffdf8); }
        ...
        /* Stok Box */
        .ds-stok { background:#f0fdf4; border:1px solid #bbf7d0; border-radius:12px; padding:1rem 1.25rem; display:flex; align-items:center; justify-content:space-between; }
        .ds-stok-lbl { font-size:11px; font-weight:700; color:#065f46; text-transform:uppercase; letter-spacing:.06em; }
        .ds-stok-val { font-size:1.5rem; font-weight:800; color:#059669; font-family:'JetBrains Mono',monospace; }
        .ds-stok-unit { font-size:.75rem; font-weight:600; color:#6ee7b7; }
    ...
    @endpush
    <div class="ds-page">
        <a href="{{ route('minyak.loading.index') }}" class="ds-back"><svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg> Kembali</a>

        <div class="ds-hdr">
            <div class="ds-hdr-ico">🚛</div>
            <div class="ds-hdr-title">Distribusi Stok ke Tanker</div>
            <div class="ds-hdr-sub">Pecah stok gudang ke beberapa mobil pengangkut sekaligus</div>
        </div>
        ...
        <form method="POST" action="{{ route('minyak.loading.distribusi.store') }}" id="form-dist">
            @csrf
            ...
            <div class="ds-card">
                ...
                <div class="ds-card-body">
                    <div class="ds-grid">
                        ...
                        <div class="ds-fld">
                            <label class="ds-lbl">Produk BBM <span class="ds-req">*</span></label>
                    ...
                    <div class="ds-stok" id="stok-box" style="display:none;">
                        <div><div class="ds-stok-lbl">Stok Gudang Tersedia</div><div style="font-size:11px;color:#6ee7b7;margin-top:2px;" id="stok-produk-name"></div></div>
            ...
            <div class="ds-card">
                <div class="ds-card-hdr">
                    ...
                    <div class="ds-card-lbl">Daftar Tanker / Mobil Pengangkut</div>
                </div>
                <div class="ds-card-body">
                    <div id="tanker-list">
                        {{-- Rows added by JS --}}
            ...
            <div class="ds-card">
                ...
                <div class="ds-card-body">
                    <div class="ds-sum">
                        ...
                        <div class="ds-sum-row"><span class="ds-sum-key">Total Distribusi (<span id="sum-count">0</span> tanker)</span><span class="ds-sum-val" id="sum-total">0 Liter</span></div>
            ...
            <div class="ds-bar">
                <a href="{{ route('minyak.loading.index') }}" class="ds-btn-cancel">Batal</a>
    ...
    function addTankerRow() {
        tankerCount++;
        var idx = tankerCount;
        var opts = '<option value="">— Pilih Tanker —</option>';
        ...
        var html = '<div class="ds-row" id="row-' + idx + '">' +
            ...
            '<div class="ds-row-grid">' +
                '<div class="ds-fld" style="margin-bottom:0"><label class="ds-lbl">Tanker / Sales</label>' +
                '<select name="items[' + idx + '][sales_id]" class="ds-sel tanker-sel" required onchange="recalc()">' + opts + '</select></div>' +
                '<div class="ds-fld" style="margin-bottom:0"><label class="ds-lbl">Volume (Liter)</label>' +
