<x-app-layout>
    ...
    <style>
        ...
        .sm-hdr-ico { width:52px; height:52px; border-radius:14px; display:flex; align-items:center; justify-content:center; font-size:1.5rem; flex-shrink:0; background:linear-gradient(135deg,#10b981,#059669); box-shadow:0 8px 24px rgba(5,150,105,0.3); }
        ...
        .sm-hdr-btn:hover { transform:translateY(-2px); box-shadow:0 8px 24px rgba(5,150,105,0.45); }
        ...
        .sm-kpi.green::before { background:linear-gradient(180deg,#10b981,#059669); }
        ...
        .sm-finput:focus { border-color:#10b981; box-shadow:0 0 0 3px rgba(16,185,129,0.12); }
        ...
        .sm-fsel:focus { border-color:#10b981; box-shadow:0 0 0 3px rgba(16,185,129,0.12); }
        .sm-btn-f { padding:0.625rem 1.25rem; border-radius:10px; font-size:0.8125rem; font-weight:600; border:none; cursor:pointer; transition:all 0.2s; font-family:inherit; background:linear-gradient(135deg,#10b981,#059669); color:#fff; box-shadow:0 4px 12px rgba(5,150,105,0.25); }
        .sm-btn-f:hover { transform:translateY(-1px); box-shadow:0 6px 18px rgba(5,150,105,0.35); }
        ...
        .sm-tbl-head { background:linear-gradient(180deg,#ecfdf5,#d1fae5); border-bottom:2px solid #6ee7b7; }
        .sm-tbl-head th { padding:0.9rem 1.25rem; font-size:0.675rem; font-weight:700; text-transform:uppercase; letter-spacing:0.07em; color:#065f46; white-space:nowrap; }
        ...
        .sm-tbl-body tr:hover td { background:linear-gradient(90deg,#f0fdf4,#ecfdf5); }
        ...
        .sm-empty-ico { width:72px; height:72px; margin:0 auto 1rem; border-radius:50%; background:linear-gradient(135deg,#ecfdf5,#d1fae5); display:flex; align-items:center; justify-content:center; }
        ...
        .sm-empty-cta { display:inline-flex; align-items:center; gap:0.5rem; padding:0.625rem 1.25rem; border-radius:10px; font-size:0.8125rem; font-weight:600; background:linear-gradient(135deg,#10b981,#059669); color:#fff; text-decoration:none; box-shadow:0 4px 14px rgba(5,150,105,0.25); transition:all 0.2s; }
    ...
    <div class="py-4">
        <div class="sm-page">
            ...
            <div class="sm-hdr">
                ...
                <a href="{{ route('minyak.stok-masuk.create') }}" class="sm-hdr-btn">
            ...
            {{-- KPI --}}
            <div class="sm-kpis">
                <div class="sm-kpi green">
                    <span class="sm-kpi-lbl">Total Penerimaan</span>
                    <div class="sm-kpi-val green">{{ number_format($stats['total_penerimaan'], 0, ',', '.') }}</div>
                    <div class="sm-kpi-foot">Semua waktu (Liter)</div>
                </div>
                <div class="sm-kpi blue">
                    ...
                    <div class="sm-kpi-foot">Selisih koreksi (Liter)</div>
                </div>
            ...
            <div class="sm-filter">
                <form method="GET" class="sm-ff">
                    ...
                    <a href="{{ route('minyak.stok-masuk.index') }}" class="sm-btn-r">Reset</a>
                </form>
            </div>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <div style="display:flex; gap:0.375rem; justify-content:center;">
                                        <a href="{{ route('minyak.stok-masuk.show', $r->id) }}" class="sm-act detail">Detail</a>
                                        @if($r->status === 'aktif')
                                        <form action="{{ route('minyak.stok-masuk.destroy', $r->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Batalkan data ini? Stok gudang akan dikurangi kembali.')">
                                            @csrf @method('DELETE')
                                ...
                                <td colspan="10">
                                    <div class="sm-empty">
                                        <div class="sm-empty-ico">
                                            <svg width="32" height="32" fill="none" stroke="#059669" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                                        </div>
                                        <div class="sm-empty-title">Belum Ada Data</div>
                                        <div class="sm-empty-sub">Mulai catat penerimaan atau koreksi stok gudang</div>
                                        <a href="{{ route('minyak.stok-masuk.create') }}" class="sm-empty-cta">
                                            <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
                                            Tambah Stok Pertama
                                        </a>
                                    </div>
