<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('minyak.sales.update', $sales) }}">
                @csrf
                @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat" rows="3" 
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('alamat', $sales->alamat) }}</textarea>
                    ...
                    <div class="p-6 border-b border-gray-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="plat_nomor" value="{{ old('plat_nomor', $sales->plat_nomor) }}"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <input type="number" name="kapasitas_tangki" value="{{ old('kapasitas_tangki', $sales->kapasitas_tangki) }}"
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
