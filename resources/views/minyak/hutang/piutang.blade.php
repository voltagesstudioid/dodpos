    ...
    <div class="py-4">
        <div class="ht-page">
            ...
            <div class="ht-hdr">
                ...
                <div>
                    <div class="ht-hdr-title">Daftar Piutang Aktif</div>
                    <div class="ht-hdr-sub">Monitoring piutang pelanggan minyak yang belum lunas</div>
                </div>
            </div>
            ...
            <div class="ht-kpis">
                <div class="ht-kpi red">
                    <div class="ht-kpi-top">
                        ...
                        <div class="ht-kpi-ico red">💰</div>
                    </div>
                    <div class="ht-kpi-val red ht-kpi-val-sm">Rp {{ number_format($stats['total_hutang'], 0, ',', '.') }}</div>
                    <div class="ht-kpi-foot">Akumulasi seluruh piutang</div>
                </div>
                <div class="ht-kpi orange">
                    <div class="ht-kpi-top">
                        <span class="ht-kpi-lbl">Belum Lunas</span>
                        <div class="ht-kpi-ico orange">⏳</div>
                    </div>
                    <div class="ht-kpi-val orange">{{ $stats['belum_lunas'] }}</div>
                    <div class="ht-kpi-foot">Piutang masih berjalan</div>
                </div>
                <div class="ht-kpi pink">
                    <div class="ht-kpi-top">
                        <span class="ht-kpi-lbl">Overdue</span>
                        <div class="ht-kpi-ico pink">⚠️</div>
                    </div>
                    <div class="ht-kpi-val pink">{{ $stats['overdue'] }}</div>
            ...
            {{-- Filter --}}
            <div class="ht-filter">
                <form method="GET" action="{{ route('minyak.hutang.piutang') }}" class="ht-ff">
                    <div class="ht-ff-fld">
                    ...
                    <div style="display:flex;align-items:flex-end;gap:0.5rem;flex:1;">
                        ...
                        <a href="{{ route('minyak.hutang.piutang') }}" class="ht-fbtn ht-fbtn-ghost" style="padding:0.45rem 1rem;">Reset</a>
                        @endif
                    </div>
                </form>
            </div>
