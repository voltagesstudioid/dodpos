        ...
        <div class="ht-page">
            ...
            <div class="ht-hdr">
                ...
                <div>
                    ...
                    <div class="ht-hdr-sub">Monitoring piutang dan pembayaran pelanggan minyak</div>
                </div>
            </div>
            ...
            <div class="ht-kpis">
                ...
                <div class="ht-kpi green">
                    <div class="ht-kpi-top">
                        ...
                        <div class="ht-kpi-ico green">✅</div>
                    </div>
                    <div class="ht-kpi-val green">{{ $stats['lunas'] }}</div>
                    <div class="ht-kpi-foot">Sudah dibayar penuh</div>
                </div>
            </div>
            ...
            <div class="ht-filter">
                <form method="GET" class="ht-ff">
                    ...
                    <a href="{{ route('minyak.hutang.index') }}" class="ht-btn-r">
