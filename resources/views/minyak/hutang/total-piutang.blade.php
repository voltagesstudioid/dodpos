    ...
    <div class="cs-page">
        ...
        <div class="cs-summary">
            ...
            <div class="cs-summary-actions">
                <a href="{{ route('minyak.hutang.piutang') }}" class="cs-btn-secondary">Kembali ke Daftar Piutang</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center;">
                                <a href="{{ route('minyak.hutang.piutang', ['pelanggan_id' => $p->id]) }}" class="cs-btn-primary cs-btn-sm">
