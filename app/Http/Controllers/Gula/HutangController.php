...
class HutangController extends Controller
{
    ...
    public function piutang(Request $request)
    {
        ...
        $query = GulaHutang::with(['pelanggan', 'penjualan.sales'])->where('status', '!=', 'lunas');
        ...
        $baseQuery = GulaHutang::where('status', '!=', 'lunas');
        if ($this->isSales()) {
            $profile = $this->getSalesProfile();
            if ($profile) {
                $baseQuery->whereHas('penjualan', function ($q) use ($profile) {
        ...
        return view('gula.hutang.piutang', compact('hutangs', 'pelanggans', 'stats', 'isSalesRole'));
    }
    ...
    public function totalPiutang(Request $request)
    {
        ...
        $pelanggans = GulaPelanggan::with(['hutangs' => function($q) use ($salesProfile) {
        ...
        return view('gula.hutang.total-piutang', compact('pelanggans', 'totalDebt', 'isSalesRole'));
    }
    ...
    public function lunas(Request $request)
    {
        ...
        return view('gula.hutang.lunas', compact('hutangs', 'pelanggans', 'isSalesRole'));
    }
