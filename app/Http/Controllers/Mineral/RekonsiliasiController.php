...
class RekonsiliasiController extends Controller
{
    public function index(Request $request)
    {
        ...
        $loadingsQuery = MineralLoading::whereDate('tanggal', $tanggal);
        if ($salesId) {
        ...
        return view('mineral.rekonsiliasi.index', compact(
            'rekonsiliasi',
            'loadings',
            'salesList',
            'tanggal',
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'sales_id' => 'nullable|exists:mineral_sales,id',
            'rekonsiliasi' => 'required|array',
            'rekonsiliasi.*.produk_id' => 'required|exists:mineral_produk,id',
        ...
        try {
            ...
            foreach ($validated['rekonsiliasi'] as $item) {
                ...
                $loadingsQuery = MineralLoading::whereDate('tanggal', $validated['tanggal'])
            ...
            AuditService::logInventory('rekonsiliasi.save', 'MineralRekonsiliasi', null, [
            ...
            return redirect()->route('mineral.rekonsiliasi.index', [
                'tanggal' => $validated['tanggal'],
