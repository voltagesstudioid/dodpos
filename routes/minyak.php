...
// --- Shared routes (all minyak roles: supervisor, admin4, sales_minyak, admin1 view-only) ---
Route::prefix('minyak')->name('minyak.')->middleware('role:supervisor|admin4|sales_minyak|admin1')->group(function () {
    // Dashboard (controller handles role-based view)
...
Route::prefix('minyak')->name('minyak.')->middleware('role:supervisor|admin4')->group(function () {
    // Hutang - Confirm/Reject Payment (supervisor only)
...
Route::prefix('minyak')->name('minyak.')->middleware('role:supervisor|admin4|admin1')->group(function () {
