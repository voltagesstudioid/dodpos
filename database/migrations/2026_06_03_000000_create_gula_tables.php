...
return new class extends Migration
{
    ...
    {
        // Tabel Sales (Salesman Gula)
        Schema::create('gula_sales', function (Blueprint $table) {
            $table->id();
        ...
        // Tabel Pelanggan Gula
        Schema::create('gula_pelanggan', function (Blueprint $table) {
            $table->id();
        ...
        // Tabel Produk Gula
        Schema::create('gula_produk', function (Blueprint $table) {
            $table->id();
            $table->string('kode_produk', 20)->unique();
            $table->string('nama', 100);
            $table->string('jenis', 50)->nullable(); // Pasir, Batu, Merah, dll
        ...
        Schema::create('gula_loading', function (Blueprint $table) {
            $table->id();
            $table->date('tanggal');
            $table->foreignId('sales_id')->constrained('gula_sales');
            $table->foreignId('produk_id')->constrained('gula_produk');
        ...
        // Tabel Penjualan Gula
        Schema::create('gula_penjualan', function (Blueprint $table) {
            $table->id();
            $table->string('no_faktur', 30)->unique();
            $table->dateTime('tanggal_jual');
            $table->foreignId('sales_id')->constrained('gula_sales');
            $table->foreignId('pelanggan_id')->constrained('gula_pelanggan');
            $table->foreignId('produk_id')->constrained('gula_produk');
        ...
        Schema::create('gula_hutang', function (Blueprint $table) {
            $table->id();
            $table->foreignId('pelanggan_id')->constrained('gula_pelanggan');
            $table->foreignId('penjualan_id')->constrained('gula_penjualan');
        ...
        Schema::create('gula_hutang_bayar', function (Blueprint $table) {
            $table->id();
            $table->foreignId('hutang_id')->constrained('gula_hutang');
        ...
        // Tabel Setoran Sales
        Schema::create('gula_setoran', function (Blueprint $table) {
            $table->id();
            $table->date('tanggal');
            $table->foreignId('sales_id')->constrained('gula_sales');
        ...
        Schema::create('gula_kunjungan', function (Blueprint $table) {
            $table->id();
            $table->foreignId('sales_id')->constrained('gula_sales');
            $table->foreignId('pelanggan_id')->constrained('gula_pelanggan');
    ...
    {
        Schema::dropIfExists('gula_kunjungan');
        Schema::dropIfExists('gula_setoran');
        Schema::dropIfExists('gula_hutang_bayar');
        Schema::dropIfExists('gula_hutang');
        Schema::dropIfExists('gula_penjualan');
        Schema::dropIfExists('gula_loading');
        Schema::dropIfExists('gula_produk');
        Schema::dropIfExists('gula_pelanggan');
        Schema::dropIfExists('gula_sales');
    }
};
