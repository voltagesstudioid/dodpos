...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Tabel Pelanggan Mineral
        Schema::create('mineral_pelanggan', function (Blueprint $table) {
            $table->id();
        ...
        // Tabel Produk Mineral
        Schema::create('mineral_produk', function (Blueprint $table) {
            $table->id();
            $table->string('kode_produk', 20)->unique();
            $table->string('nama', 100);
            $table->string('jenis', 50)->nullable(); // Galon, Botol, Dus, Gelas, dll
        ...
        Schema::create('mineral_loading', function (Blueprint $table) {
            $table->id();
            $table->date('tanggal');
            $table->foreignId('sales_id')->constrained('mineral_sales');
        ...
        // Tabel Penjualan Mineral
        Schema::create('mineral_penjualan', function (Blueprint $table) {
            $table->id();
            $table->string('no_faktur', 30)->unique();
            $table->dateTime('tanggal_jual');
            $table->foreignId('sales_id')->constrained('mineral_sales');
            $table->foreignId('pelanggan_id')->constrained('mineral_pelanggan');
            $table->foreignId('produk_id')->constrained('mineral_produk');
        ...
        Schema::create('mineral_hutang', function (Blueprint $table) {
            $table->id();
            $table->foreignId('pelanggan_id')->constrained('mineral_pelanggan');
            $table->foreignId('penjualan_id')->constrained('mineral_penjualan');
        ...
        Schema::create('mineral_hutang_bayar', function (Blueprint $table) {
            $table->id();
            $table->foreignId('hutang_id')->constrained('mineral_hutang');
        ...
        // Tabel Setoran Sales
        Schema::create('mineral_setoran', function (Blueprint $table) {
            $table->id();
            $table->date('tanggal');
            $table->foreignId('sales_id')->constrained('mineral_sales');
        ...
        Schema::create('mineral_kunjungan', function (Blueprint $table) {
            $table->id();
            $table->foreignId('sales_id')->constrained('mineral_sales');
            $table->foreignId('pelanggan_id')->constrained('mineral_pelanggan');
    ...
    {
        Schema::dropIfExists('mineral_kunjungan');
        Schema::dropIfExists('mineral_setoran');
        Schema::dropIfExists('mineral_hutang_bayar');
        Schema::dropIfExists('mineral_hutang');
        Schema::dropIfExists('mineral_penjualan');
        Schema::dropIfExists('mineral_loading');
        Schema::dropIfExists('mineral_produk');
        Schema::dropIfExists('mineral_pelanggan');
